...
const signupWithGoogle = () => {
  ...
  // Redirect to Google OAuth endpoint - same as login, it handles both
...
<Field>
          ...
          <FieldGroup>
            <Field>
              ...
              >
                <Loader2 v-if="googleLoading" class="w-4 h-4 mr-2 animate-spin" />
                <svg v-else xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-4 h-4 mr-2">
                  <path
